...
| justify | flex 布局下的水平排列方式(微信小程序暂不支持)                                                                                                                                      | String              | start  | start center end space-around space-between |
| gutter  | 栅格间隔，可以写成像素值或支持响应式的对象写法来设置水平间隔 { xs: 8, sm: 12, md: 16, lg: 18, xl: 20, xxl: 24}。或者使用数组形式同时设置 [水平间距, 垂直间距],(微信小程序暂不支持) | String,Object,Array | 0      | -                                           |
...
| order  | 栅格顺序，flex 布局模式下有效(微信小程序暂不支持)                         | Number        | 0      | -      |
| pull   | 栅格向左移动格数                                                          | Number        | 0      | -      |
| push   | 栅格向右移动格数                                                          | Number        | 0      | -      |
| span   | 栅格占位格数，为 0 时相当于 display: none                                 | Number        | 1      | -      |
| xs     | <480px 响应式栅格，可为栅格数或一个包含其他属性的对象(微信小程序暂不支持) | Number,Object | -      | -      |
| sm     | ≥576 响应式栅格，可为栅格数或一个包含其他属性的对象(微信小程序暂不支持)   | Number,Object | -      | -      |
| md     | ≥768 响应式栅格，可为栅格数或一个包含其他属性的对象(微信小程序暂不支持)   | Number,Object | -      | -      |
| lg     | ≥992 响应式栅格，可为栅格数或一个包含其他属性的对象(微信小程序暂不支持)   | Number,Object | -      | -      |
| xl     | ≥1200 响应式栅格，可为栅格数或一个包含其他属性的对象(微信小程序暂不支持)  | Number,Object | -      | -      |
| xxl    | ≥1600 响应式栅格，可为栅格数或一个包含其他属性的对象(微信小程序暂不支持)  | Number,Object | -      | -      |
